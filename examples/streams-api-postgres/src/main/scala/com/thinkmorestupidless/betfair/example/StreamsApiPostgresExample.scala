...
object StreamsApiPostgresExample {

  private val log = LoggerFactory.getLogger(getClass)

  def main(args: Array[String]): Unit = {
    log.info("streams api postgres example starting")
    ...
    Betfair
      .create(maybeGlobalMarketFilterRepository = Some(SlickMarketFilterRepository()))
      .map { betfair =>
