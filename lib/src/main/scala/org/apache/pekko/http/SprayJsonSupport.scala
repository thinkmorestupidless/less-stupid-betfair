...
final class JsonEntityStreamingSupport (
  ...
  override def withFramingRendererFlow(framingRendererFlow: org.apache.pekko.stream.javadsl.Flow[ByteString, ByteString, NotUsed]): JsonEntityStreamingSupport =
